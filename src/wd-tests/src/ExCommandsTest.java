...
public class ExCommandsTest extends WasaviTest {
	...
	public void testMapAmbiguousIssue55 () {
		Wasavi.send(":map [clear]\n");
		Wasavi.send(":map! ,zz <enter>bb, cc<enter>\n");
		Wasavi.send("i,zz\u001b");
	...
	@Test
	public void testReplaceMappedChar () {
		Wasavi.send(":map [clear]\n");
		Wasavi.send(":map a bc\n");
		Wasavi.send("ifoobar\u001b");

		Wasavi.send("0ra");
		assertValue("#1-1", "aoobar");
	}
	...
	@Test
	public void issue85_substAllRest () {
		Wasavi.send(":sushi\n");
		Wasavi.send("3ibee \u001byy2p1G");

		Wasavi.send(":%s/b/BB/gc\nyyya");
		assertValue("#1-1",
				"BBee BBee BBee \n" +
				"BBee BBee BBee \n" +
				"BBee BBee BBee ");
