...
function make_js () {
	...
	echo "// line break property in Unicode $version\n";
	echo "// generated by $argv[0] $argv[1]\n";
	echo "/*const*/var BREAK_PROP = {\n";
	$delimiter = "";
	foreach ($props as $prop => $offset) {
		echo sprintf("\t'%s': %3d", $prop, $offset);
		if ($prop != "XX") {
			echo ",";
		}
		echo "\n";
